...
// Both texts below were transcribed and checked line-by-line against the Walt Whitman
// Archive (whitmanarchive.org), retrieved via Wayback Machine snapshots since the live
// site blocks automated access. See src/content/sources.ts for exact citations.

// 1856 second-edition text ("Sun-Down Poem"), which had no numbered sections.
export const sunDown1856: PoemSection[] = [
  {
    stanzas: [
      [
...
// 1891–92 "deathbed" edition text, in Whitman's final numbered sections.
export const deathbed1892: PoemSection[] = [
  {
    number: '1',
    stanzas: [
      [
